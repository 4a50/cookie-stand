...
Store.prototype.generateHTML = function (tagPlacement) {
  var createSection = document.createElement('section');
  createSection.setAttribute('id', `${this.idName}-store`);
  document.getElementsByTagName(tagPlacement)[0].appendChild(createSection);
...
Store.prototype.displayDailyCookies = function () {
  //Store Name H2 header
  this.generateHourlyCookies();
  this.generateHTML('main');
  //
  var timeHour = 6;
